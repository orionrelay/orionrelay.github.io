...
import { $fetch } from "D:/Work/ORION/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "D:/Work/ORION/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "D:/Work/ORION/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "D:/Work/ORION/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu } from "D:/Work/ORION/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "D:/Work/ORION/node_modules/ufo/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "D:/Work/ORION/node_modules/@unhead/vue/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Cy6zpKOs.js")
  },
  {
    name: "company",
    path: "/company",
    component: () => import("./_nuxt/company-CNLXgQ1p.js")
  },
  {
    name: "inquiry",
    path: "/inquiry",
    component: () => import("./_nuxt/inquiry-BA1z4_A9.js")
  },
  {
    name: "products",
    path: "/products",
    component: () => import("./_nuxt/products-eZ4A7QzB.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-CGfW_Nz3.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DseDUYAR.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-QPGskxJ2.js"));
