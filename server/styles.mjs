...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.BJkVSFLz.mjs').then(interopDefault),
  "pages/index.vue": () => import('./_nuxt/index-styles.L60pFCvp.mjs').then(interopDefault),
